										...
										<div class="card p-4">
											<div class="card-body">
                                                ...
                                                <form method="POST" action="{{ route('login') }}">
													...
													<div class="row">
														<div class="col-12">
															<button type="submit" id="submit" class="btn btn-lg btn-primary btn-block">{{ __('Login') }}<i class="fe fe-arrow-right"></i></button>
														</div>
													</div>
                                                </form>
												<a href="{{ route('register') }}" class="btn btn-success btn-block mt-2">Register<i class="fe fe-arrow-right"></i></a>
											</div>
										</div>
									</div>
								</div>
